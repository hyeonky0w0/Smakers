    ...
    public void run(String... args) {
        ...
        List<Asset> defaults = List.of(
                ...
                Asset.builder()
                        ...
                        .assetUrl("https://example.com/assets/suspension.png")
                        .build(),
                ...
                Asset.builder()
                        ...
                        .assetUrl("https://example.com/assets/v4-engine.png")
                        .build()
        );
